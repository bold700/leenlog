...
| 29 jul | ICTU — UX-Expert, 25 mnd | Hero (Queenten Leonora) | ❌ afgewezen 18 aug: uiteindelijk niet voorgesteld (afwijzing was nooit aangekomen) | — | — | Concept klaar: netjes afsluiten + aanbevolen houden voor volgende aanvragen |
...
| 20 jul | UX Designer/Researcher, Utrecht, schaal 11 | Caesar (Lisa van Meijeren / Merel Kok) | 🔥 gebeld 18 aug: Roos doet álle Defensie-aanvragen. Focus: **verlenging huidige opdracht opnieuw proberen** + ze biedt Kenny actief aan op al haar aanvragen (cv ligt bij haar) | — | — | Roos aan zet; eind vd week geen update → kort appen/bellen (06 81 72 24 88). Cv v3 uit Figma exporteren en naar Roos sturen |
| 5 aug | UX-expert | Greenpepper (Lotte op vakantie; **Niek** pakt op, 06 57 48 86 15) | 🔥🔥 **GESPREK KOMT ERAAN**: door selectie heen, gespreksmoment wordt gepland (Niek belt terug over hoe/wat) | €100 haalbaar | — | Interviewprep NU prioriteit: 3 cases (Defensie stakeholders, AMP design system, AI-workflow) + expliciet UI-enthousiasme tonen |
